                                                ...
                                                <ul>
                                                    <li data-index="rs-5" data-transition="fade"
                                                        ...
                                                        data-param10="" data-description=""> <img
                                                            src="upload/images/home/s1.png" alt="" title="slider-hp2-1"
                                                        ...
                                                        <div class="tp-caption   tp-resizeme" id="slide-5-layer-1"
                                                            ...
                                                            style="z-index: 5; white-space: nowrap; font-size: 33px; line-height: 33px; font-weight: 300; color: #0066B3; letter-spacing: 0px;font-family:Poppins;">
                                                        ...
                                                        <div class="tp-caption   tp-resizeme" id="slide-5-layer-2"
                                                            ...
                                                            data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                                            data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                                            style="z-index: 6; white-space: nowrap; font-size: 88px; line-height: 88px; font-weight: 700; color: #0066B3; letter-spacing: 0px;font-family:Playfair Display;">
                                                            CHARUSAT</div>
                                                        ...
                                                        <div class="gdlr-core-column-service-content-wrapper">
                                                            <div class="gdlr-core-column-service-title-wrap">
                                                                <h3 class="gdlr-core-column-service-title gdlr-core-skin-title"
                                                                    id="h3_1dd7_0" style="font-size: 28px;">Publications</h3>
                                                                <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption"
                                                                    id="div_1dd7_3" style="color:black;font-size: 26px;">1181+</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr"
                                                        ...
                                                        <div class="gdlr-core-column-service-content-wrapper">
                                                            <div class="gdlr-core-column-service-title-wrap">
                                                                <h3 class="gdlr-core-column-service-title gdlr-core-skin-title"
                                                                    id="h3_1dd7_3" style="font-size: 28px;">Research Labs</h3>
                                                                <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption"
                                                                    id="div_1dd7_12" style="color:black;font-size: 26px;">30+</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr"
                                                        ...
                                                        <div class="gdlr-core-column-service-content-wrapper">
                                                            <div class="gdlr-core-column-service-title-wrap">
                                                                <h3 class="gdlr-core-column-service-title gdlr-core-skin-title"
                                                                    id="h3_1dd7_2" style="font-size: 26px;">Entrepreneurs</h3>
                                                                <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption"
                                                                    id="div_1dd7_9" style="color:black;font-size: 26px;">300+</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-column-service-item gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-column-service-icon-left gdlr-core-with-caption gdlr-core-item-pdlr"
                                                        ...
                                                        <div class="gdlr-core-column-service-content-wrapper">
                                                            <div class="gdlr-core-column-service-title-wrap">
                                                                <h3 class="gdlr-core-column-service-title gdlr-core-skin-title"
                                                                    id="h3_1dd7_1" style="font-size: 28px;">Patents</h3>
                                                                <div class="gdlr-core-column-service-caption gdlr-core-info-font gdlr-core-skin-caption"
                                                                    id="div_1dd7_6" style="color:black;font-size: 26px;">18</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
